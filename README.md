...
Google Play uploads should use the release Android App Bundle. Before uploading, run the stricter publish check. It requires release signing credentials, runs release lint, and builds the release bundle:
